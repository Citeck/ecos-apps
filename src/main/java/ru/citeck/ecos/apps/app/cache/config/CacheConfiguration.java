package ru.citeck.ecos.apps.app.cache.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("eapps");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("eapps");
        ...
        config.getMapConfigs().put("ru.citeck.ecos.apps.domain.*", initializeDomainMapConfig(jHipsterProperties));
