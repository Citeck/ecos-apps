package ru.citeck.ecos.apps.web.rest.errors;
...
import ru.citeck.ecos.apps.app.application.api.rest.errors.ErrorConstants;
import ru.citeck.ecos.apps.app.application.api.rest.errors.ExceptionTranslator;
